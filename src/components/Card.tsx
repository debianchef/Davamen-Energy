...
const Card: FC<CardProps> = ({ imgSrc, title }) => {
  return (
    <div
     ...
     hover:bg-white flex-1 cursor-pointer h-[210px] xs:h-[290px] min-w-fit sm:min-w-[330px]
    ...
    >
      ...
      <p
        className="text-black absolute -top-12 left-1/2 -translate-x-1/2 opacity-0 group-hover:top-0.5 group-hover:opacity-100
      transition-all duration-700 ease-in-out text-center w-full px-8 text-base sm:text-lg z-10 "
      >
        {title}
      </p>
    </div>
